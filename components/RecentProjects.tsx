        ...
        <div className="py-20" id="projects">
            ...
            <div className="flex flex-wrap items-center justify-center p-4 gap-x-44 gap-y-8 mt-10">
                {projects.map(({
                    ...
                    <div key={id}
                         className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5] flex items-center justify-center sm:w-[520px] w-[80vw]">
                        <PinContainer title={link} href={link}>
                            <div
                                className="relative flex items-center justify-center sm:w-[570px] w-[80vw]
                                overflow-hidden sm:h-[40vh] h-[30vh] mb-10 rounded-xl">
                                <div className="relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]">
                                    <img src={"/bg.png"} alt={"bg-img"}/>
                                </div>
                                <img src={img} alt={title} className={`z-10 absolute bottom-0 scale-110 ${style}`}/>
                            </div>
